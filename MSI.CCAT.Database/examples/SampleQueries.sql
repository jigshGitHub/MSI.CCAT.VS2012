...
select * from Tbl_Account where OwnerId=6
...
WHERE cm.accountnumber = '11115555'-- cs.Value = 'NCRA' and act.OwnerId = 32

select * from Tbl_ComplaintMain where AccountNumber = '11115555'
update Tbl_ComplaintMain set ComplaintStatusId = 4 where ComplaintId = 'MSI-555-129'

delete from Tbl_ComplaintMain where AccountNumber = '11115555' and ComplaintId = 'MSI-555-730'